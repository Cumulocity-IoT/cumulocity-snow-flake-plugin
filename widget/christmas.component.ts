...
@Component({
  ...
  template: ` <button
      ...
      *ngIf="isActive"
      title="End Christmas"
    >
      <i [c8yIcon]="'sun'" class="icon-2x"></i>
    </button>
    <button
      class="main-header-button"
      title="Start Christmas"
      (click)="start()"
      *ngIf="!isActive"
    >
      <i [c8yIcon]="'snowflake-o'" class="icon-2x"></i>
    </button>
    <audio #audioElement>
      <source src="/apps/sag-pkg-snow-flake/song.mp3" type="audio/mpeg" />
    </audio>`,
})
